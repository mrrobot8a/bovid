...
public interface IFtpService {
    ...
    InputStream downloadFileFromFTP(String ftpRelativePath, String folder) throws FtpErrors, java.io.IOException, InterruptedException, ExecutionException, TimeoutException;
